...
//                   </span>
//                 </span>
//                 <span className="text-sm text-gray-300">Range: 10 - 2048</span>
//               </div>
...
//               )}
//               {isSubmitting ? "VERIFYING..." : "SUBMIT FOR VERIFY"}
//             </motion.button>
//           )}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                    {tokens.map((token, index) => (
                      <motion.div
                        ...
                        whileHover={{ y: -10 }}
                      >
                        <RealisticHammer index={index} />
                        <p className="text-xs text-gray-400 bg-gray-800 px-2 py-1 rounded w-full text-center break-all">
                          {token}
                        </p>
                      </motion.div>
                    ))}
